...
class Bookmark(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL,on_delete=models.SET_NULL, verbose_name=_(u"user"), blank=True, null=True)
...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.SET_NULL,verbose_name=_(u"user"),null=True)
